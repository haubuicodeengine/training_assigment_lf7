...
public class CourseModelImpl extends BaseModelImpl<Course>
	...
	public static final String ORDER_BY_SQL = " ORDER BY Course_Course.name ASC";
	public static final String DATA_SOURCE = "liferayDataSource";
	public static final String SESSION_FACTORY = "liferaySessionFactory";
	public static final String TX_MANAGER = "liferayTransactionManager";
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.course.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.liferay.course.model.Course"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.course.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.liferay.course.model.Course"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.course.service.util.ServiceProps.get(
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.course.service.util.ServiceProps.get(
	...
	public void setLecturer(String lecturer, Locale locale, Locale defaultLocale) {
		...
		if (Validator.isNotNull(lecturer)) {
			setLecturer(LocalizationUtil.updateLocalization(getLecturer(),
					"Lecturer", lecturer, languageId, defaultLanguageId));
		}
		else {
			setLecturer(LocalizationUtil.removeLocalization(getLecturer(),
					"Lecturer", languageId));
		}
	}
	...
	public void setLecturerMap(Map<Locale, String> lecturerMap,
		...
		setLecturer(LocalizationUtil.updateLocalization(lecturerMap,
